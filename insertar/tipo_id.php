...
<div align="center">
    <form action="create/InsertarTipo_id.php" name="IR" method="post">
  <table width="362" border="1">
    ...
    <tr>
      <td>Descripcion Tipo ID </td>
      <td>
          <input name="des_tipo_id" type="text" maxlength="30" />      </td>
    </tr>
    <tr>
      <td>Siglas</td>
      <td>
        <input type="text" name="siglas" />      </td>
    </tr>
    <tr>
