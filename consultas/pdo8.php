...
try{
	...
	$sql="SELECT count(aprendiz.id_apre),des_causa FROM aprendiz,desercion,causadesercion,ficha,centro where desercion.id_apre=aprendiz.id_apre and desercion.cod_causa=causadesercion.cod_causa and desercion.num_ficha=ficha.num_ficha and ficha.cod_centro=centro.cod_centro group by des_causa";
